...
public class LoginF extends javax.swing.JFrame {
    ...
    LoginF(JScrollPane contentScrollPane) {
    ...
    private void btnLoginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLoginActionPerformed
        // TODO add your handling code here:
         try (Connection conn = DriverManager.getConnection("jdbc:"+DB_TYPE+"://"+DB_HOST+":"+DB_PORT+"/"+DB_NAME,DB_USER,DB_PASS))  {
            ...
            //Connection conn = DriverManager.getConnection("jdbc:"+DB_TYPE+"://"+DB_HOST+":"+DB_PORT+"/"+DB_NAME,DB_USER,DB_PASS); 
           ...
           String sql =  "select * from login WHERE username = '"+username+"' and password = '"+password+"'";
            ...
            if(rs.next()){
                ...
                JOptionPane.showMessageDialog(this,"gabisa login");
                edtUsername.setText("");
                edtPassword.setText("");
            }
